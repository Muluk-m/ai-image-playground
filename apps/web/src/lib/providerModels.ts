...
export const PROVIDER_MODEL_OPTIONS: Record<string, string[]> = {
  // DALL-E 2/3 已于 2026-05-12 退役，gpt-image-1 为旧版，本清单不再展示；
  // 保留 gpt-image-2 是因为 BYOK key 仍可能只有它的权限。用户也可手输任意模型 ID。
  openai: ['gpt-image-2.5-flare', 'gpt-image-2.5-sunburst', 'gpt-image-2'],
  gemini: ['gemini-3.1-flash-image', 'gemini-3.1-flash-image-preview', 'gemini-2.5-flash-image'],
}
