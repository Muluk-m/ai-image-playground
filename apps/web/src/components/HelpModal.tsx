            ...
            <>
              <section>
                ...
                <div className="space-y-4">
                  <p>
                    在历史记录卡片上
                    <strong className="text-blue-500 dark:text-blue-400 font-medium">
                      左右滑动
                    </strong>
                    即可选中或取消选中该卡片。
                  </p>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <p>
                    ...
                    <strong className="text-gray-500 dark:text-gray-400 font-medium">
                      取消选择
                    </strong>
                    、
                    <strong className="text-blue-500 dark:text-blue-400 font-medium">
                    ...
                    、
                    <strong className="text-yellow-500 dark:text-yellow-400 font-medium">
                      批量收藏
                    </strong>
                    、
                    <strong className="text-green-500 dark:text-green-400 font-medium">
                      批量下载
                    </strong>
                    ，和
                    <strong className="text-red-500 dark:text-red-400 font-medium">批量删除</strong>
                    。
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <ul className="list-disc pl-4 space-y-2">
                    ...
                    <li>
                      按住{' '}
                      <kbd className="px-1.5 py-0.5 rounded-md bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-xs font-sans">
                        Ctrl
                      </kbd>{' '}
                      或{' '}
                      <kbd className="px-1.5 py-0.5 rounded-md bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-xs font-sans">
