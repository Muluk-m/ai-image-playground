            ...
            <div data-selectable-text className="flex-1">
              ...
              {showSourceInfo && (
                <div className="mb-2 rounded-lg bg-gray-50 px-3 py-2 text-xs dark:bg-white/[0.03]">
                  <span className="text-gray-400 dark:text-gray-500">{t('detail.source')}</span>
                  <br />
              ...
              <div className="grid grid-cols-2 gap-2 text-xs mb-4">
                <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2">
                  <span className="text-gray-400 dark:text-gray-500">{t('param.size')}</span>
                  <br />
                  <DetailParamValue
                    task={task}
                    paramKey="size"
                ...
                <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2">
                  <span className="text-gray-400 dark:text-gray-500">{t('param.quality')}</span>
                  <br />
                  <DetailParamValue
                    task={task}
                    paramKey="quality"
                ...
                <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2">
                  <span className="text-gray-400 dark:text-gray-500">{t('param.format')}</span>
                  <br />
                  <DetailParamValue
                    task={task}
                ...
                <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2">
                  <span className="text-gray-400 dark:text-gray-500">{t('param.moderation')}</span>
                  <br />
                  <DetailParamValue
                    task={task}
                    paramKey="moderation"
                ...
                <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2">
                  <span className="text-gray-400 dark:text-gray-500">{t('param.count')}</span>
                  <br />
