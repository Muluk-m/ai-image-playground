import type { ProductShotBatchItem, ProductShotImage } from '../types'
import { isDiagram } from './scene'

function isBatchCandidate(image: ProductShotImage, sampleImageId: string | null): boolean {
...
export function batchDoneCount(items: readonly ProductShotBatchItem[]): number {
