...
export const CHOICE =
  'w-full rounded-lg border border-white/[0.12] px-2.5 py-1.5 text-left text-xs text-[#e8e8ea] transition hover:border-blue-500/60 hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-45 disabled:hover:border-white/[0.12] disabled:hover:bg-transparent'
