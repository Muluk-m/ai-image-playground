import { type GuideContent, list, note, p, prompt, shot, steps, table, tip, warn } from '../model'
...
export const guideEn: GuideContent = {
  ...
  chrome: {
    ...
    chaptersTitle: 'Browse by chapter',
    ...
    searchPlaceholder: 'Search features, buttons or questions',
  ...
  home: {
    image: img('home'),
    imageAlt:
      'The Muvloom Create page: sidebar navigation, the prompt box with parameters, and inspiration and works below',
  },
  chapters: [
    {
      id: 'getting-started',
      ...
      summary:
        'Learn the interface, generate your first image, then review, download and refine it.',
      meta: {
        title: 'Getting started: generate your first AI image - Muvloom',
        description:
          'Get started with Muvloom: tour the Create page, generate your first AI image, then review, download, reuse settings and refine results, synced to the cloud once you sign in.',
      },
      subsections: [
        {
          id: 'interface',
          ...
          blocks: [
            p('The Create page is the Muvloom home page. It consists of the following areas:'),
            shot(
              img('home'),
        ...
        },
        {
          ...
          blocks: [
            ...
            table(
              ...
              [
                'A specific detail',
                'Click [[Edit output]], paint the area and describe the change. See [Inpainting](/guide/en/create/#mask-edit).',
              ],
              [
                'Comparing versions',
                'Click [[Send to canvas]], annotate the image and generate alongside it. See [Canvas](/guide/en/canvas/).',
              ],
              [
                'Hard to describe in words',
                'Let the [AI agent](/guide/en/agent/) interpret your request and write the prompt.',
              ],
            ),
          ],
        },
    ...
    },
    {
      ...
      meta: {
        title: 'The Create page: prompts, references and inpainting - Muvloom',
        description:
          'Write prompts on the Muvloom Create page, add reference images and @ mentions, batch generate with slots, set model, size and ratio, and inpaint with masks.',
      },
      intro: [
        p(
    ...
    },
    {
      ...
      meta: {
        title: 'AI agent: design in plain language - Muvloom',
        description:
          'The Muvloom AI agent writes prompts from your request and generates after you confirm, with skills for product hero images, image sets, posters, scene swaps and localization.',
      },
      intro: [
        p(
    ...
    },
    {
      ...
      meta: {
        title: 'Assets: subjects, prompts and templates - Muvloom',
        description:
          'Manage canvas projects on the Muvloom Assets page, save product and person assets, reuse saved prompts, and batch generate consistent product images with templates.',
      },
      intro: [
        p(
